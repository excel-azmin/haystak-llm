...
warnings.filterwarnings("ignore",
                        message="Dep005: You are using weaviate-client version 3.26.4. The latest version is 4.6.5.")
...
MONGO_URI = "mongodb://68.183.81.8:27011"
...
# Function to update embeddings in batches with proper handling
